...
{
    /// <summary>
    /// Shared configuration for all demo classes
    /// Centralizes common setup logic
    /// </summary>
    public static class DemoConfiguration
    {
        ...
        {
            public const string BaseUrl = "https://localhost:7263/api";
        ...
        {
            public const string TestCampaignId = "3fd2f1a1-aaf1-49d1-9a8a-0661415eb429";
            public const decimal ExpensiveBudgetThreshold = 100000m;
        ...
        public static ServiceProvider ConfigureServices()
        {
            ...
            // Configure ApiContext with standard settings
            ...
            // No Services registration needed - we use Repositories directly!
